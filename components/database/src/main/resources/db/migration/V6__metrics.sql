...
GRANT SELECT, INSERT, UPDATE ON users.metrics_tokens_costs_history TO squonk;
GRANT SELECT, INSERT, UPDATE, DELETE ON users.metrics_tokens_costs TO squonk;
GRANT SELECT, INSERT, UPDATE, DELETE ON users.metrics_tokens_usage TO squonk;

GRANT USAGE ON SEQUENCE users.metrics_tokens_costs_history_id_seq TO squonk;
GRANT USAGE ON SEQUENCE users.metrics_tokens_costs_id_seq TO squonk;
GRANT USAGE ON SEQUENCE users.metrics_tokens_usage_id_seq TO squonk;
