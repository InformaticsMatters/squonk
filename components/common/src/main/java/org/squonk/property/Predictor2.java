 ...
 */
public abstract class Predictor2<V extends Object, T extends Object, C extends Calculator2<V,T>> {

    private final String[] resultNames;
    private final Property<V,T>[] propertyTypes;

    public Predictor2(String resultName, Property<V,T> propertyType) {
        resultNames = new String[] {resultName};
        propertyTypes = new Property[] {propertyType};
    }

    public Predictor2(String[] resultNames, Property<V,T>[] propertyTypes) {
