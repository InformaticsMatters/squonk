...
import com.im.lac.services.job.service.adapters.SimpleCamelJobAdapter;
 ...
 * @author timbo
 */
public class AsyncLocalJob extends AbstractDatasetServiceJob<AsyncLocalProcessDatasetJobDefinition> {
    ...
    protected Class getDefaultAdapterClass() {
        return SimpleCamelJobAdapter.class;
    }
