...
public interface Step {
 ...
 VariableManager1 and the names expected by the implementation. Keys are the names
 ...
 variables are handled through the VariableManager1. If the input variable
