...
public class DatasetRouteBuilder extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("direct:/datasets/delete")
                ...
                .beanRef(ImplConstants.DATASET_HANDLER, "deleteDataset")
                .transform(constant("OK"));

        from("direct:/datasets/list")
                .beanRef(ImplConstants.DATASET_HANDLER, "listDataItems");

        from("direct:/datasets/dataitem")
                .setBody(header("item")).convertBodyTo(Long.class)
                .beanRef(ImplConstants.DATASET_HANDLER, "getDataItem");

        from("direct:/datasets/content")
                .setBody(header("item")).convertBodyTo(Long.class)
                .beanRef(ImplConstants.DATASET_HANDLER, "fetchJsonForDataset")
