 ...
 */
class EnamineRealDsiTable extends RDKitTable {

    EnamineRealDsiTable(String schema, String baseTableName) {
    ...
    EnamineRealDsiTable() {
        this(IOUtils.getConfiguration("CHEMCENTRAL_SCHEMA", "vendordbs"),
                IOUtils.getConfiguration("CHEMCENTRAL_TABLE", "enamine_real_dsi"))
    }
}
