...
public class MemoryVariableClient implements VariableClient {
    ...
    public String readTextValue(Long notebookId, Long sourceId, String variableName, String key) {
        String k = generateKey(notebookId, sourceId, variableName, key);
    ...
    public String generateKey(Long notebookId, Long sourceId, String variableName, String key) {
        String s = notebookId + "#" + sourceId + "#" + variableName;
    ...
    public void writeTextValue(Long notebookId, Long editableId, Long cellId, String variableName, String value, String key) {
        String k = generateKey(notebookId, editableId, variableName, key);
